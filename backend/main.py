...
from api.routes import health, quiz, topics, auth, progress, personalization, topic_requests, mastery, auth_raw
...
app.include_router(auth_raw.router, prefix="/api/v1/auth", tags=["auth"])
